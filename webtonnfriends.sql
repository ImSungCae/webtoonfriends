...
insert into t_goods_image (image_id,goods_id,filename,reg_id,filetype,credate) VALUES(314,008,'물위의 우리 모자 + 슬리퍼 세트(블랙)_메인.jpg','admin','main_image',TO_DATE('22/10/17','RR/MM/DD'));
insert into t_goods_image (image_id,goods_id,filename,reg_id,filetype,credate) VALUES(315,008,'물위의 우리 모자 + 슬리퍼 세트(블랙)_서브1.jpg','admin','sub_image1',TO_DATE('22/10/17','RR/MM/DD'));
...
insert into t_shop_goods (goods_id,goods_sort,goods_title,goods_writer_intro,goods_price,goods_delivery_price,goods_delivery_date,goods_status) VALUES (3,'화산귀환','화산귀환 갤럭시 하드케이스','갤럭시 S21 하드케이스 (무광)',18000,3000,TO_DATE('22/10/16','RR/MM/DD'),NULL);
...
insert into t_shop_goods (goods_id,goods_sort,goods_title,goods_writer_intro,goods_price,goods_delivery_price,goods_delivery_date,goods_status) VALUES (8,'물위의우리','물위의 우리 모자 + 슬리퍼 세트(블랙)','모자 + 슬리퍼 세트 (블랙)',49900,3000,TO_DATE('22/10/17','RR/MM/DD'),'newgoods');
